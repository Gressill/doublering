...
public class PeopleHandler extends DefaultHandler {//继承DefaultHandler重写startElement解析XML
	...
	public void startElement(String uri, String localName, String qName,
    	...
    	if ("id".equals(qName)){
    		...
    		cur_qName = "content";
    	}else if("db:location".equals(qName)){
    		cur_qName = "location";
    		String wid = attributes.getValue("id");
    		_pentry.put("location_id", wid);
    	}else if("db:uid".equals(qName)){
    		cur_qName = "uid";
    	}
    ...
    private void store(){
    	...
    	try{
    		...
    		String sqlInsert = "INSERT INTO `dr_user`(`uid`,`title`,`douban_id`,`douban_link`,`location_id`,`location`,`content`) VALUES ('"+
